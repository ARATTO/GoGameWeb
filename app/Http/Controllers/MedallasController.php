   ...
   public function store(Request $request)
    {
    	...
    	$cadena1="select medalla.nombremedalla,medalla.imagenmedalla,detallemedalla.cantidadminimapuntos from detallemedalla inner join materiaimpartida on detallemedalla.idmateriaimpartida=materiaimpartida.id inner join materia on materiaimpartida.IDMATERIA=materia.id inner join medalla on detallemedalla.IDMEDALLA=medalla.id";
